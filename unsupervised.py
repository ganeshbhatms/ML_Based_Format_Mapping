...
def unsupervisedLearning():
    ...
    def cosine_sim(text1, text2):
        ...
        targetText = "".join([x.lower() for x in text2])
        sourceText = "".join([y.lower() for y in text1])
    ...
    trainData['confidence']= cosine_sim(trainData['sourceField'],trainData['targetField'])
